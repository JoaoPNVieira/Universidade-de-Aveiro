...
def run_client(client_sock, client_id):
    ...
    #-----------------------------------------
    #CODIGO DE TESTE
    #Testar situação em que o cliente envia operação Stop com um número de tentativas não coerente
    #-----------------------------------------
    opStart = {"op": "START", "client_id": userID}
    START = sendrecv_dict(client_sock, opStart)
    print("\nMensagem do Servidor:")
    print(START)
    
    opStop = {"op": "STOP", "number": 32, "attempts": 2}
