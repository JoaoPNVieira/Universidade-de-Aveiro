...
def run_client(client_sock, client_id):
    ...
    #-----------------------------------------
    #CODIGO DE TESTE
    #Testar situação em que o cliente envia operação inválida
    #-----------------------------------------
    opStart = {"op": "START", "client_id": "Roberto"}
    START = sendrecv_dict(client_sock, opStart)
    print("\nMensagem do Servidor:")
    print(START)
    
    opNew = {"op": "XPTO", "number": 32, "attempts": 2}
    inMSG = sendrecv_dict(client_sock, opNew)
    print("\nMensagem do Servidor:")
    print(inMSG)
    print("\n")
    validate_response(client_sock, inMSG)
