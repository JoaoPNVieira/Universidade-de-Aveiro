...
-- Design Ports Information
-- LEDG[0]	=>  Location: PIN_R7,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDG[1]	=>  Location: PIN_U4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDG[2]	=>  Location: PIN_R2,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- LEDG[3]	=>  Location: PIN_U3,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[2]	=>  Location: PIN_R4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[1]	=>  Location: PIN_R6,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- SW[0]	=>  Location: PIN_R3,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- Equation(s):
-- \system_core|outputs[1]~1_combout\ = (\SW[2]~input_o\ & (!\SW[1]~input_o\ & \SW[0]~input_o\))
...
-- Equation(s):
-- \system_core|outputs[2]~2_combout\ = (\SW[2]~input_o\ & (\SW[1]~input_o\ & !\SW[0]~input_o\))
...
-- Equation(s):
-- \system_core|outputs[3]~3_combout\ = (\SW[2]~input_o\ & (\SW[1]~input_o\ & \SW[0]~input_o\))
