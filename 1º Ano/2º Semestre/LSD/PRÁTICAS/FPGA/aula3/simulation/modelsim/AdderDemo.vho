...
SIGNAL \inst|bit2|s~combout\ : std_logic;
SIGNAL \inst|bit1|s~combout\ : std_logic;
...
-- Equation(s):
-- \inst|bit0|cout~0_combout\ = (\SW[8]~input_o\ & ((\SW[0]~input_o\) # (\SW[4]~input_o\))) # (!\SW[8]~input_o\ & (\SW[0]~input_o\ & \SW[4]~input_o\))
...
-- Equation(s):
-- \inst|bit1|cout~0_combout\ = (\SW[1]~input_o\ & ((\inst|bit0|cout~0_combout\) # (\SW[5]~input_o\))) # (!\SW[1]~input_o\ & (\inst|bit0|cout~0_combout\ & \SW[5]~input_o\))
...
-- Equation(s):
-- \inst|bit2|cout~0_combout\ = (\SW[6]~input_o\ & ((\inst|bit1|cout~0_combout\) # (\SW[2]~input_o\))) # (!\SW[6]~input_o\ & (\inst|bit1|cout~0_combout\ & \SW[2]~input_o\))
...
-- pragma translate_on
PORT MAP (
	datab => \inst|bit2|cout~0_combout\,
	datac => \SW[3]~input_o\,
	datad => \SW[7]~input_o\,
...
\inst|bit2|s\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|bit2|s~combout\ = \SW[6]~input_o\ $ (\inst|bit1|cout~0_combout\ $ (\SW[2]~input_o\))
...
PORT MAP (
	...
	datac => \inst|bit1|cout~0_combout\,
	datad => \SW[2]~input_o\,
	combout => \inst|bit2|s~combout\);

-- Location: LCCOMB_X114_Y15_N12
\inst|bit1|s\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|bit1|s~combout\ = \SW[1]~input_o\ $ (\inst|bit0|cout~0_combout\ $ (\SW[5]~input_o\))
...
PORT MAP (
	...
	datab => \inst|bit0|cout~0_combout\,
	datac => \SW[5]~input_o\,
	combout => \inst|bit1|s~combout\);

-- Location: LCCOMB_X114_Y15_N6
\inst|bit0|s~0\ : cycloneive_lcell_comb
-- Equation(s):
-- \inst|bit0|s~0_combout\ = \SW[8]~input_o\ $ (\SW[0]~input_o\ $ (\SW[4]~input_o\))
