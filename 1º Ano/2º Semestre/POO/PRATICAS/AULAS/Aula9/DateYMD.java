...
public class DateYMD extends DateAula7 implements Comparable<DateYMD>{
    ...
    //METODO COMPARE TO
    public int compareTo(DateYMD obj) {
		return (this.day + this.month*31 + this.year*365) - (obj.getDay() + obj.getMonth()*31 + obj.getYear()*365);
    }
}