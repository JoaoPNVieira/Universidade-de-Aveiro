...
#
# Fundamentos de Programação students:
# This is not a required subject!
# Use the module just as a service to trace the execution of functions.
#
# Modifies the function so that an execution trace is shown.
