...
```
condicoesPagamento: (codigo, nome, prazo)
PK: codigo

tipoFornecedor: (codigo, nome)
PK: codigo

Fornecedor: (codigo, nome, endereco, nif, fax, condPag_codigo, TipoForn_codigo)
PK: codigo
FK(s): condPag_codigo, TipoForn_codigo

Encomenda: (numero, data, fornecedor)
PK: numero
FK(s): fornecedor

Produto: (codigo, nome, preco, tava_iva)

Armazém: (codigo, morada, contacto)
PK: codigo
```
...
Encomenda-Produto:
    - Grau: 2
    - Cardinalidade: 1:1..N
    - Obrigatoriedade: Produto

Encomenda-Fornecedor:
    - Grau: 2
    - Cardinalidade: N:1
    - Obrigatoriedade: Fornecedor

Fornecedor-condicoesPagamento:
    - Grau: 2
    - Cardinalidade: 1:N
    - Obrigatoriedade: condicoesPagamento

Fornecedor-tipoFornecedor:
    - Grau: 2
    - Cardinalidade: N:1
    - Obrigatoriedade: tipoFornecedor
```
