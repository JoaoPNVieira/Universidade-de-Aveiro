export async function getItems(){
    ...
    for (const item of ditems) {
        obj = {Id: item.id, ProductName: item.title, ProductDescription: item.descrip, Category: item.category, ImagePath: item.imagePath, Price: item.price, Stock: item.stock}
